...
<body>
  ...
  <h1>Edit Option: </h1>
    <form  method="POST">
      ...
      <table class="edit" style="border: 1px solid black; font-family: cursive; font-size: 25px; margin:1rem; padding: 5px;" bgcolor="grey">
        ...
        <tr>
          <td colspan="2" rowspan="3"><textarea name="update" id="update" style="width: 20rem; height: 6rem; outline: none; font-size: 18px; font-family: sans-serif; border: 1px solid black; padding: 3px;" placeholder="Write Here..."></textarea></td>
        </tr>
        <tr class="button">
  ...
  <h4 style="text-align: center;"><a href="logout.php" style="color: black;">Logout</a></h4>
